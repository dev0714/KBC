...
CREATE INDEX IF NOT EXISTS idx_payfast_client_payments_client_id
  ON public.payfast_client_payments(client_id);

CREATE INDEX IF NOT EXISTS idx_payfast_client_payments_status
  ON public.payfast_client_payments(status);
...
CREATE INDEX IF NOT EXISTS idx_payfast_itn_logs_order_id
  ON public.payfast_itn_logs(order_id);

CREATE INDEX IF NOT EXISTS idx_payfast_itn_logs_m_payment_id
  ON public.payfast_itn_logs(m_payment_id);

CREATE INDEX IF NOT EXISTS idx_payfast_itn_logs_status
  ON public.payfast_itn_logs(processing_status);
