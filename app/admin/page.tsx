  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#000034] via-[#002463] to-[#0056a1]">
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside
          className={`w-64 bg-gradient-to-b from-[#0056a1]/40 to-[#002463]/40 border-r border-slate-400/30 fixed md:static h-screen overflow-y-auto transition-transform z-30 backdrop-blur-sm ${
